...
const BASE_URL = "http://localhost:8000/rageval";
const ENDPOINTS = [
  {
    "method": "GET",
    "path": "/health",
    "desc": "Health check.",
    "body": null,
    "response": "{\"status\":\"ok\",\"service\":\"rageval\"}"
  },
  {
    "method": "POST",
    "path": "/eval/score",
    "desc": "Score a RAG response for relevance, groundedness, and faithfulness.",
    "body": "{\n  \"query\": \"What is RAG?\",\n  \"answer\": \"RAG stands for Retrieval-Augmented Generation.\",\n  \"chunks\": [\"RAG is a technique that...\", \"Generation is enhanced by...\"]\n}",
    "response": "{\"relevance\":0.92,\"groundedness\":0.88,\"faithfulness\":0.95,\"cost_usd\":0.0003,\"latency_ms\":1240}"
  },
  {
    "method": "POST",
    "path": "/eval/log",
    "desc": "Score and persist to history DB.",
    "body": "{\"query\":\"...\",\"answer\":\"...\",\"chunks\":[\"...\"],\"session_id\":\"my-app-001\"}",
    "response": "{\"relevance\":0.87,\"groundedness\":0.91,\"faithfulness\":0.89}"
  },
  {
    "method": "GET",
    "path": "/eval/metrics",
    "desc": "Aggregate metrics for last N days.",
    "body": null,
    "response": "{\"total_queries\":142,\"avg_relevance\":0.88,\"avg_faithfulness\":0.91,\"total_cost_usd\":0.04}"
  },
  {
    "method": "GET",
    "path": "/eval/queries",
    "desc": "List logged evaluations.",
    "body": null,
    "response": "[{\"id\":1,\"query\":\"...\",\"relevance\":0.9,\"model\":\"gemini-2.0-flash\"}]"
  }
];
    ...
    <div style={{ padding:"24px 32px",maxWidth:1100,color:"#e2e8f0" }}>
      <div style={{ display:"flex",alignItems:"center",gap:12,marginBottom:8 }}>
        ...
        <div>
          ...
          <p style={{ margin:0,fontSize:"0.85rem",color:"#94a3b8" }}>{"Evaluate RAG pipelines programmatically — plug into any LLM system"}</p>
        </div>
      </div>
