    ...
    <div className="p-8 max-w-5xl mx-auto h-full overflow-y-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">
          RAGeval Benchmarking - User Guide
        </h1>
      </div>

      <p className="text-lg text-gray-300 mb-8 leading-relaxed">
        RAGeval evaluates your Retrieval-Augmented Generation pipelines for accuracy, hallucination rate, and context relevance.
      </p>
        ...
        <section className="bg-gray-800/50 backdrop-blur-md p-8 rounded-xl border border-gray-700 shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
              <h3 className="font-semibold text-blue-400 text-lg mb-2">1. Multi-Judge Consensus</h3>
              <p className="text-sm text-gray-300">RAGeval leverages a panel of LLM judges (OpenAI, Anthropic, Groq, Gemini) to score answers. It automatically falls back to Gemini if primary API keys are missing.</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
              <h3 className="font-semibold text-purple-400 text-lg mb-2">2. Metrics Dashboard</h3>
              <p className="text-sm text-gray-300">Visualize Answer Relevancy, Faithfulness, and Context Precision across different models.</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
              <h3 className="font-semibold text-amber-400 text-lg mb-2">3. OpenTelemetry (OTEL) Export</h3>
              <p className="text-sm text-gray-300">Seamlessly export all evaluation traces and span timings to standard OTEL collectors (Jaeger, Prometheus) using the `@track` decorator.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gray-800/50 backdrop-blur-md p-8 rounded-xl border border-gray-700 shadow-2xl">
          <h2 className="text-2xl font-bold mb-4 flex items-center gap-2 text-white">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mb-3">To run RAGeval locally, ensure the following environment variables are set in your <code>.env</code> file:</p>
              <ul className="list-disc list-inside text-sm font-mono text-green-300 space-y-2 ml-2 bg-gray-950 p-4 rounded-lg">
                <li><code>EVAL_DATABASE_URL</code></li>\n<li><code>OPENAI_API_KEY</code></li>\n<li><code>ANTHROPIC_API_KEY</code></li>
              </ul>
