...
RAGeval offers scientifically rigorous evaluation metrics:
- **Synthetic Edge-Case Triplet Generation**: Automated extraction of evaluation quadruplets $(Document, Question, GroundTruthContext, ModelAnswer)$.
- **Orthogonal RAG Triad Metrics**: Quantitative Faithfulness, Context Precision, Context Recall, and Answer Relevance formulations.
- **Harmonic RAG Triad Score**: Unified statistical score quantifying overall retrieval-generation alignment.

For full mathematical proofs and dataset details, see [RESEARCH.md](RESEARCH.md).
